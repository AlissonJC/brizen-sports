...
def handicap(competition, home, away, handicap_home):
    ...
    if flag_home == 1:
        print(f"{away}")
        return odds_home, -handicap_home, away
    elif flag_away == 1:
        print(f"{home}")
        return odds_away, handicap_home, home
...
def flags(competition):
    ...
    return f"{country[0].upper()} {country_name} {emoji.emojize(':american_football:')}\n"
