...
def goals_in_competition(competition, team):
    ...
    print(f"Average points scored home: {goals_scored_home/games_home:.4}")
    print(f"Average points conceded home: {goals_conceded_home/games_home:.4}")
    print(f"Average points scored away: {goals_scored_away/games_away:.4}")
    print(f"Average points conceded away: {goals_conceded_away/games_away:.4}")
...
team_average_spread(competition, team, spread)
